...
<body style="background-image: light.jpg;">

	<div class="container col-md-6" id="header">
		<div id="heading">
			<h1 class="display-4" style="color:white;">Secret Diary</h1>
			<h5  style="color:white;">Store your thoughts permanently and securely</h5>
		</div>
		...
		<div id="signUp">
				<h6  style="color:black;">Interested ? <br>Sign Up Now!!</h6>
				<form method="post">
				...
				<p style="color:black;" ><b>Already registered ??</b></h1><a href="#" id="clickLogIn" style="color:black;"><strong><b><br> Log in</b></strong></a></p>
		</div>

		<div id="logIn">
			<h6  style="color:pink;">Please Log in</h6>
				<form method="post">
					  <div class="form-group">
					    <input type="email" name="email" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Enter email">
					  </div>
				...
				<p><a href="#" id="changePassword" style="color:white;"> Forgot password</a></p>
		</div>
